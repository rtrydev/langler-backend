...
func TestValidateOrthography(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "medial ha with long u", text: "လှူ", valid: true},
		{name: "medial ha with long i", text: "မှီ", valid: true},
		{name: "medial ra on nga", text: "ငြိမ်းချမ်းရေး", valid: true},
		{name: "la stack", text: "ပလ္လင်", valid: true},
		{name: "atomic great u", text: "ဦး", valid: true},
		{name: "atomic au", text: "ဩဂုတ်", valid: true},
