...
func tokenHandler(t *testing.T, manager *fakeAgentTokenManager) *httpapi.Handler {
	t.Helper()
	handler, err := httpapi.NewHandler(fakeStatusProvider{}, &fakeReferenceProvider{}, &fakeLessonImporter{}, &fakeLessonLibrary{}, &fakeLessonPromptBuilder{}, &fakeLessonResultRecorder{}, manager)
	if err != nil {
